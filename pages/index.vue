      ...
      <div class="max-w-6xl">
        <div class="relative">
          <div class="relative z-10 grid gap-3 grid-cols-6">
            <div class="col-span-full lg:col-span-2 overflow-hidden flex relative  ">
              <Panel>
            ...
            <div class="col-span-full lg:col-span-2 overflow-hidden flex relative  ">
              <Panel :loading="authStore.loading">
                <UButton @click="authStore.me()">Loading mask test</UButton>
              </Panel>
            </div>
            <div class="col-span-full lg:col-span-2 overflow-hidden flex relative  ">
              <Panel>
            ...
            <div class="col-span-full lg:col-span-2 overflow-hidden flex relative  ">
              <Panel>
                <UButton label="Modal test" @click="isOpen = true"/>
              </Panel>
            </div>
            <div class="col-span-full lg:col-span-2 overflow-hidden flex relative  ">
              <Panel/>
